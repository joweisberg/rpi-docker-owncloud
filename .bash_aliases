...
alias cpmini='rsync -rpthW --inplace --no-compress --exclude=.bin/ --delete --info=progress2'
alias cpfull='rsync -ahW --inplace --no-compress --exclude=.bin/ --delete --info=progress2'
